...
import AIAssistant from '../components/AIAssistant'; // Yahan import kiya
  ...
  return (
    <html lang="fr" className={`${inter.variable} ${cormorant.variable} antialiased`}>
      <body className="font-sans min-h-screen relative overflow-x-hidden bg-[#FBF6F0] text-[#1C1410] flex flex-col">
        ...
        <main className="flex-1 pt-24 px-6 md:px-12 max-w-[1400px] mx-auto w-full">
          {children}
        </main>

        <Footer />

        {/* Global Overlays (Modals & Drawers hamesha end mein hone chahiye) */}
        <CartDrawer />
        <AIAssistant /> {/* Floating AI Chatbot yahan add kar diya */}
